...
public class Coche {
	...
	/**
	 * Devuelve la fuerza de aceleración del coche, de acuerdo al motor definido
	 * en la práctica 2
	 ** 
...
//			return FUERZA_BASE_ADELANTE * (miVelocidad / 250 * 0.5 + 0.5);
			...
			return FUERZA_BASE_ATRAS * 0.85;  //85 %
	}
